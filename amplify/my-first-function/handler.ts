        ...
        try {
            ...
            if (body.action === 'translate') {
                ...
                return {
                    statusCode: 200,
                    headers: corsHeaders,
                    body: JSON.stringify({ success: true, translated })
                };
            }
                    ...
                    itinerary: [
                        {
                            ...
                            title: "1日目 - 到着と市内観光",
                            activities: [
                                { time: "09:00", name: "空港到着", location: "羽田空港", type: "transport", description: "空港に到着し、市内へ移動", estimatedCost: "500 JPY", duration: "30 minutes", tips: "電車が便利です" },
                                { time: "11:00", name: "ホテルチェックイン", location: "新宿", type: "transport", description: "ホテルにチェックインして荷物を預ける", estimatedCost: "0 JPY", duration: "30 minutes", tips: "早めのチェックインがおすすめ" },
                                { time: "12:30", name: "ランチ", location: "新宿", type: "food", description: "地元の美味しいレストランで昼食", estimatedCost: "2000 JPY", duration: "1 hour", tips: "予約をしておくと安心" }
                            ]
                        }
                    ]
                }
