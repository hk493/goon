        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                {t('downloadOfflineDataDescription')}
              </p>
              <button
          ...
          {syncQueue.length > 0 && (
            <div className="bg-yellow-50 rounded-xl p-6">
              ...
              <p className="text-gray-600 mb-4">
                {t('pendingSyncDescription', { count: syncQueue.length })}
              </p>
          ...
          {offlineData && (
            <div className="bg-indigo-50 rounded-xl p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                <div>
                  <span className="font-medium text-gray-700">{t('lastUpdated')}:</span>
                  <span className="ml-2 text-gray-600">
                    {new Date(offlineData.lastUpdated).toLocaleString()}
                  </span>
                </div>
                <div>
                  <span className="font-medium text-gray-700">{t('dataSize')}:</span>
